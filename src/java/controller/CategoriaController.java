    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       if(request.getParameter("Registrar")!=null){
           ...
           if(CategoriaDAO.registrar(c)){
               ...
               request.setAttribute("mensaje", "No se ha registrado la categoria");
           }
       }else if (request.getParameter("Eliminar")!=null){
           if(CategoriaDAO.eliminar(c)){
               request.setAttribute("mensaje", "se ha elimnado la categoria");
           }else{
               request.setAttribute("mensaje", "No se ha podido elimnar");
           }
