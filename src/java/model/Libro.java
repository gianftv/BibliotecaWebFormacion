...
public class Libro implements Serializable{
    ...
    private String publicacion; //la fecha que se publico por eso la metemos como string. se va parsear de date a string
    private String fecha_registro;//la recibimos en string y la parseamos
